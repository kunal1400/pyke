		...
		?>
			...
			<p>
				...
				<select class="widefat" name="<?php echo $this->get_field_name('style_effect'); ?>" id="<?php echo $this->get_field_id('style_effect'); ?>">
					<option value="effect-image" <?php selected('effect-image', $instance['style_effect']) ?>><?php esc_html_e('effect-image Corner', 'themeftc') ?></option>
					<option value="effect-border-image" <?php selected('effect-border-image', $instance['style_effect']) ?>><?php esc_html_e('Border Scale', 'themeftc') ?></option>
